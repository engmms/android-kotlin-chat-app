...
class RecentListAdapter(val context: Context, var conversations: MutableList<Conversation>,val listener:OnUserClick?=null) : androidx.recyclerview.widget.RecyclerView.Adapter<ViewHolder>() {
